# Source: https://github.com/nv-tlabs/semanticGAN_code/blob/main/utils/inception_utils.py
...
=======
        if prints:
            ...
            pass
>>>>>>> 867e5d55d2354d6538c38cfdf7a2992202e9f203
        if use_torch:
...
def sample_gema(g_ema, device, nz, batch_size):
    with torch.no_grad():
        g_ema.eval()
